...
export const TransactionsListSection = ({ statusFilter, typeFilter, visibleColumns }: TransactionsListSectionProps): JSX.Element => {
  const filteredTransactions = transactionData.filter(transaction => {
    const statusMatch = !statusFilter || transaction.status === statusFilter;
    const typeMatch = !typeFilter || transaction.representing.role === typeFilter;
